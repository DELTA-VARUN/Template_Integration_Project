...
class EmpList(ListView):
    model = Employee
    template_name = 'CBVEmp/list.html'

class EmpForms(CreateView):
    model = Employee
    fields = "__all__"
    template_name = 'CBVEmp/forms.html'
    success_url = '/'

class EmpDetail(DetailView):
    model = Employee
    template_name = 'CBVEmp/detail.html'

class EmpUpdate(UpdateView):
    model = Employee
    fields = '__all__'
    template_name = 'CBVEmp/update.html'
    success_url = '/'


class EmpDelete(DeleteView):
    model = Employee
    template_name = 'CBVEmp/delete.html'
    success_url = '/'
