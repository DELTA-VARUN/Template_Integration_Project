...
from CSE.views import EmpList, EmpForms, EmpDetail, EmpUpdate, EmpDelete
...
urlpatterns = [
    ...
    path('forms', EmpForms.as_view(), name='Empforms'),
    path('<pk>/detail', EmpDetail.as_view(), name='detail'),
    path('<pk>/update', EmpUpdate.as_view(), name='update'),
    path('<pk>/delete', EmpDelete.as_view(), name='delete'),
